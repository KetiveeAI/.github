...
New to Ketivee? Here's how to jump in:

1. **Explore our repositories** — browse the projects above and find one that interests you.
2. **Read the contribution guidelines** — review [CONTRIBUTING.md](CONTRIBUTING.md) before submitting anything.
3. **Pick up an issue** — start with a [Good First Issue](https://github.com/ketiveeai/ketivee-docs/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) if you're new.
4. **Join the community** — hop into our [Discord](https://blog.ketivee.com) to introduce yourself and ask questions.

### Resources

- 📖 [Contribution Guidelines](CONTRIBUTING.md)
- 📚 [Documentation](https://docs.ketivee.com)

---

## Community

Stay up to date and connect with the Ketivee community across our channels:

| Platform | Link |
|----------|------|
| 💬 Discord | [discord.gg/PCwcr82T](https://discord.gg/PCwcr82T) |
| 🐦 Twitter / X | [@KetiveeAI](https://x.com/KetiveeAI) |
...
Ketivee is community-driven and free to use. If you'd like to support our work, consider donating or sponsoring the project — it helps us keep the lights on and build more great tools.

[![Donate](https://img.shields.io/badge/Donate-FF5F5F?style=for-the-badge)](https://github.com/ketivee-org/ketivee-donation)
[![Sponsor](https://img.shields.io/badge/Sponsor-EA4AAA?style=for-the-badge&logo=github-sponsors&logoColor=white)](https://github.com/sponsors/ketivee-org)

---

## License

This project is open source. See individual repositories for their respective licenses.
